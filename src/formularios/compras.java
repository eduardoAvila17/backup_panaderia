...
//        fecha.setText(acceso.fechasistema);
    ...
    private void initComponents() {
        ...
        txtcosto1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                txtcosto1KeyPressed(evt);
            }
            public void keyTyped(java.awt.event.KeyEvent evt) {
                txtcosto1KeyTyped(evt);
            }
        });
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(txtcosto1, javax.swing.GroupLayout.PREFERRED_SIZE, 93, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
...
////            //    }
 ...
 VentanaBuscar buscador = new VentanaBuscar("SELECT BARRA, concat(UPPER(descripcion), '  -  ' , precio_venta) AS descripcion\n"
    ...
    private void txtcosto1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtcosto1KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtcosto1KeyPressed

    private void txtcosto1KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtcosto1KeyTyped
        // TODO add your handling code here:
    }//GEN-LAST:event_txtcosto1KeyTyped
    ...
    private void grabar() {
        ...
        if (res == javax.swing.JOptionPane.OK_OPTION) {
            ...
            for (int fila = 0; fila < grilla.getRowCount(); fila++) {
              gencodDetalle();
                conn.sentencia.executeUpdate("insert into detalle_compras(id,id_cabecera,item,id_producto,barra_producto,precio,cantidad,total,estado)values(" + id_detalle + "," + txtcodigo.getText() + "," + grilla.getValueAt(fila, 0) + "," + grilla.getValueAt(fila, 1) + "," + grilla.getValueAt(fila, 2) + "," + grilla.getValueAt(fila, 4) + "," + grilla.getValueAt(fila, 5) + "," +0+ "," +1+ ")");
     ...
     private void tirar_grillas() {
        try {
            do {
                ...
                String campos[] = new String[]{String.valueOf(c), txtID.getText(), txtbarra.getText(), txtdescripcion.getText(), txtcosto.getText(),txtcantidad.getText()};
                dt.addRow(campos);
