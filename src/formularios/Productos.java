    ...
    private void grabar() {
        ...
        try {
            ...
            if (bandera.equals("agregar")) {
                ...
                conn.sentencia.executeUpdate("INSERT INTO producto(prd_cod,tip_prd_cod,presen_cod,mar_cod,unid_cod,descripcion,costo,iva,estado,barra,precio_venta)values(" + txtcodigo.getText() + "," + 1 + "," + 1 + "," + 1 + "," + 1 + ",'" + descripcion.getText() + "'," + costo.getText() + "," + 1 + "," + estado + "," + txtbarra.getText() + "," + precio_venta.getText() + ")");
            ...
            if (bandera.equals("editar")) {
                ...
                conn.sentencia.executeUpdate("UPDATE producto SET barra ='" + txtbarra.getText() + "',descripcion='" + descripcion.getText() + "', costo='" + costo.getText() + "' ,precio_venta='" + precio_venta.getText() + "',estado=" + estado + " WHERE prd_cod =" + txtcodigo.getText());
